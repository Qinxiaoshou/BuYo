...
public class MySearchAdapter extends CommonAdapter<SearcherBean> {
    ...
    public void convert(ViewHolder holder, int position) {
        holder.setImageResource(R.id.item_search_iv_icon,mData.get(position).getIconId())
                .setText(R.id.tv_name,mData.get(position).getTitle())
                .setText(R.id.tv_address,mData.get(position).getContent())
                .setText(R.id.tv_phone,mData.get(position).getComments());
    }
}
