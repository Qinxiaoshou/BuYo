...
public class BusinessUpdateBusinessPerssionFragment extends Fragment {
    ...
    public BusinessUpdateBusinessPerssionFragment(List<Cloth> cloths, String bId, RadioGroup rg_h_open_permission) {
        this.cloths = cloths;
        this.bId  = bId;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new BusinessUpdateBusinessPerssionDataRecyclerViewAdapter(getActivity(),cloths,bId,rg_h_open_permission));
    }
}
