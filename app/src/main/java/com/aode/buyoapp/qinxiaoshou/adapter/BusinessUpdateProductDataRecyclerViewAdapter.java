...
public class BusinessUpdateProductDataRecyclerViewAdapter extends RecyclerView.Adapter<BusinessUpdateProductDataRecyclerViewAdapter.ViewHolder> {
    ...
    public BusinessUpdateProductDataRecyclerViewAdapter(Context mContext) {
    ...
    public BusinessUpdateProductDataRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.business_update_product_massage_content, parent, false);
