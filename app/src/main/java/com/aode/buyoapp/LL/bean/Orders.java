...
public class Orders implements Serializable{
    ...
    public Orders(Long id, String address, String description, Double price, Integer length, String state, String uId, Date date, String bId, Long cId, String pId, String buyer, String issuer, Business business, Cloth cloth) {
        this.id = id;
